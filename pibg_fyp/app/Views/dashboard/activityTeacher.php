...
<form action="<?= base_url('activitycontroller/create') ?>" method="post">
    <?= csrf_field(); ?>
            ...
            <td>
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="<?= base_url('activitycontroller/update/'.$activity['fld_id']) ?>" method="post">
                ...
                <a href="<?= base_url('activitycontroller/delete/'.$activity['fld_id']) ?>" class="btn btn-danger btn-sm">Delete</a>
            </td>
        </tr>
    <?php endforeach; ?>
</table>
