...
<style>
    ...
    <form action="AdminController/saveResult" method="post">
        ...
        <?php foreach ($resultInfo as $result): ?>
            ...
            <?php foreach ($studentInfo as $student): ?>
                ...
                <td><button type="button" class="btn btn-sm btn-warning"data-toggle="modal" data-target="#exampleModal<?= $result['result_id'] ?>">Edit</button>
                    <a href="<?= base_url('AdminController/delete/'.$result['result_id']) ?>" class="btn btn-danger btn-sm">Delete</a>
...
<div class="modal-dialog" role="document">
    ...
    <div class="modal-body">
        ...
        <form action="<?= base_url('Admincontroller/updateResult/'.$result['result_id']) ?>" method="post">
