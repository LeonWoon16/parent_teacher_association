    ...
    <tbody>
        <?php foreach ($studentInfo as $student): ?>
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#example<?= $student['fld_id'] ?>">Details</button>
                    <!-- Modal -->
                    <div class="modal fade" id="example<?= $student['fld_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
